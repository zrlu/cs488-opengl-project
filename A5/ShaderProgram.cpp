...
//------------------------------------------------------------------------------------
void ShaderProgram::attachTessellationControlShader (
		const char * filePath
) {
    tessellationControlShader.shaderObject = createShader(GL_TESS_CONTROL_SHADER);
    tessellationControlShader.filePath = filePath;

    extractSourceCodeAndCompile(tessellationControlShader);
}

//------------------------------------------------------------------------------------
void ShaderProgram::attachTessellationEvaluationShader (
		const char * filePath
) {
    tessellationEvaluationShader.shaderObject = createShader(GL_TESS_EVALUATION_SHADER);
    tessellationEvaluationShader.filePath = filePath;

    extractSourceCodeAndCompile(tessellationEvaluationShader);
}
...
void ShaderProgram::link() {
    ...
    if(tessellationControlShader.shaderObject != 0) {
        glAttachShader(programObject, tessellationControlShader.shaderObject);
    }

    if(tessellationEvaluationShader.shaderObject != 0) {
        glAttachShader(programObject, tessellationEvaluationShader.shaderObject);
    }
