...
double Perlin::octaveNoise(double x, double y, double z, unsigned int octaves)
{
    double result = 0.0;
    double amp = 1.0;
...
double Perlin::octaveNoise(double x, double y, unsigned int octaves)
{
    return octaveNoise(x, y, 0, octaves);
}